...
public final class Isi extends Biodata implements Karakter, Detektif, Anak, Persamaan{
    ...
    public Isi() {
        ...
        switch (pilih){
            ...
            case 2 :
                this.id = 2;
                character(tampilDetektif());
                tampilProfile();
                break;
            case 3 :
                this.id = 3;
                character(tampilAnak());
                tampilProfile();
                break;
            case 4 :
                this.id = 4;
    ...
    public int tampilDetektif(){
        ...
        System.out.print("Pilih Detektif  : ");
    ...
    @Override
    public void child(int pilihan) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public int tampilAnak() {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        System.out.println("\n======Pilih Anak======");
        System.out.println("1. Shinichi Kudo (工藤 新一)/Conan Edogawa (江戸川コナン)");
        System.out.println("2. Sherry (シェリー)/Ai Haibara (灰原哀)");
        ...
        System.out.print("Pilih Anak : ");
        Scanner scanner = new Scanner(System.in);
        return scanner.nextInt();
    }

    @Override
    public void Detective(int pilihan) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    @Override
    public void persamaan(int pilihan) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
